...
<script type="text/javascript">
	...
	$('#ResetBtn').on('click', function () {
            window.location.href = "{{route('backend.reports.favourited.videos.list')}}";
...
<h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
    <div>Favourited Videos List</div>
</h4>
...
<div class="card">
    ...
    <div class="card-datatable table-responsive">
        <table id="video-list" class="table table-striped table-bordered">
            <thead>
                <tr>
				<form action="" id="filterForm"  action="{{route('backend.reports.favourited.videos.list')}}" method = "get"  >
